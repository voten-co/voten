...
class SubmissionVotesController extends Controller
{
     ...
     *
     * @param integer $voter_id
     * @param mixed $previous_vote
     * @param integer $submission_id
     * @return void
     */
    protected function updateUserUpVotesRecords($voter_id, $author_id, $previous_vote = null, $submission_id)
    {
     ...
     * @return void
     */
    protected function updateUserDownVotesRecords($voter_id, $author_id, $previous_vote = null, $submission_id)
    {
        $downvotes = $this->submissionDownvotesIds($voter_id);
