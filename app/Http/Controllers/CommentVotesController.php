...
class CommentVotesController extends Controller
{
     ...
     * @return void
     */
    protected function updateUserUpVotesRecords($voter_id, $author_id, $previous_vote = null, $comment_id)
    {
     ...
     * @return void
     */
    protected function updateUserDownVotesRecords($voter_id, $author_id, $previous_vote = null, $comment_id)
    {
        $downvotes = $this->commentDownvotesIds($voter_id);
