...
!(function(a) {
  ...
  (a.shortnames = c.join("|")), (a.asciiList = {
    ...
    "https://cdn.jsdelivr.net/emojione/assets/png/"), (a.imagePathSVG =
    "https://cdn.jsdelivr.net/emojione/assets/svg/"), (a.imagePathSVGSprites =
    "./../assets/sprites/emojione.sprites.svg"), (a.imageType =
    "png"), (a.imageTitleTag = !0), (a.sprites = !1), (a.unicodeAlt = !0), (a.ascii = !1), (a.cacheBustParam =
    "?v=2.2.7"), (a.regShortNames = new RegExp(
    ...
    return (b = b.replace(a.regShortNames, function(b) {
      return "undefined" != typeof b && "" !== b && b in a.emojioneList
        ? (
            (c =
              a.emojioneList[b].unicode[a.emojioneList[b].unicode.length - 1]),
      ...
      (b = b.replace(a.regAscii, function(b, g, h, i) {
        ...
        a.unescapeHTML(i) in a.asciiList
          ? (
              (i = a.unescapeHTML(i)),
              (d = a.asciiList[i]),
              (f = a.imageTitleTag ? 'title="' + a.escapeHTML(i) + '"' : ""),
              (e = a.unicodeAlt ? a.convert(d.toUpperCase()) : a.escapeHTML(i)),
              (c =
                "png" === a.imageType
                  ? a.sprites
                    ? h +
    ...
    if (!a.unicodeReplacementRegEx || !a.memMapShortToUnicodeCharacters) {
      var b = [];
      (a.memMapShortToUnicodeCharacters = {}), a.mapEmojioneList(function(
        c,
        d
      ) {
        var e = a.convert(c);
        a.emojioneList[d].isCanonical &&
          (a.memMapShortToUnicodeCharacters[e] = d), b.push(e);
...
})((this.emojione = this.emojione || {})), "object" == typeof module &&
  (module.exports = this.emojione);
