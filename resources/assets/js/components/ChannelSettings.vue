<template>
    <section>
        ...
        <div class="form-group">
            <div class="flex-space">
                ...
                <div class="edit-avatar-preview">
                    <img :alt="Store.page.channel.temp.name" :src="Store.page.channel.temp.avatar" class="circle"/>
                </div>
            </div>
        </div>
        ...
        <crop-modal :visible.sync="showImageCropModal" v-if="showImageCropModal" :type="'channel'"></crop-modal>
    </section>
</template>
