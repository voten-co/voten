<template>
    <section class="container margin-top-5 col-7" id="help">
        <div class="align-center margin-bottom-3">
            <router-link to="/help">
                <svg xmlns="http://www.w3.org/2000/svg" width="150px" height="150px" viewBox="0 0 100 100" class="heroicon-buoy heroicon heroicon-lg">
                    <g fill-rule="evenodd">
        ...
        <div class="flex-space simple-box user-select">
            <h3>
                Was this article helpful?
            </h3>

            <div>
                <button class="v-button v-button--green">
                    Yes
                </button>

                <button class="v-button v-button--red">
                    No
                </button>
            </div>
        </div>
