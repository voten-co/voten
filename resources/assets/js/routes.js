...
const routes = [
  ...
  { path: "/channel", component: NewCategory, meta: { title: "New #Channel" } },
  {
    ...
    component: SubscribedCategories,
  ...
  { path: "/big-daddy", redirect: "/big-daddy/reports/submissions" },
  {
    ...
    children: [
        ...
        children: [
          {
            ...
            name: "admin-panel-all-users"
          },
          {
            path: "ban",
            component: AdminPanelBanUser,
            name: "admin-panel-ban-users"
          }
        ]
      },
      {
      ...
      },
      {
        ...
        component: AdminPanelReportedSubmissions,
        name: "admin-panel-reported-submissions"
      },
      {
        path: "reports/comments",
        component: AdminPanelReportedComments,
        name: "admin-panel-reported-comments"
      },
      {
        path: "suggested-categories",
        component: AdminPanelSuggestedCategories,
        name: "admin-panel-suggested-categories"
      }
    ]
  },
    ...
    children: [
      { path: "", component: UserSubmissions, name: "user-submissions" },
      {
        ...
        children: [
          {
            path: "account",
            component: UserSettingsEditAccount,
            name: "user-settings-account"
          },
          {
            path: "profile",
            component: UserSettingsEditProfile,
            name: "user-settings-profile"
          },
          {
            path: "feed",
            component: UserSettingsEditFeed,
            name: "user-settings-feed"
          },
          {
            path: "email-and-password",
            component: UserSettingsEditEmailAndPassword,
            name: "user-settings-email-and-password"
          }
        ]
      },
  ...
  { path: "/c/:name/mod", redirect: "/c/:name/mod/reports/submissions" },
  {
    ...
    children: [
      {
        path: "",
        component: CategorySubmissions,
        name: "category-submissions"
      },
      {
        path: "mod",
  ...
  { path: "/bookmarks", redirect: "/bookmarks/submissions" },
  {
    ...
    children: [
      ...
      {
        path: "channels",
        component: BookmarkedCategories,
        name: "bookmarked-categories",
